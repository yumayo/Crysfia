...
bool AppDelegate::applicationDidFinishLaunching( ) {
    ...
    if ( !glview ) {
        ...
        glview = GLViewImpl::createWithRect( env->gameName, cocos2d::Rect( 0, 0, env->designResolutionSize.width, env->designResolutionSize.height ) );
    #else
    ...
    glview->setDesignResolutionSize( env->designResolutionSize.width, env->designResolutionSize.height, ResolutionPolicy::NO_BORDER );
