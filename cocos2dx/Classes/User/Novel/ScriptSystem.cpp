    ...
    : ScriptBase( layer )
{
    ...
    // 古いバージョンのインスタンス命令
    REGIST_FUNC_NAME( ScriptSystem, SetHeart, "heart" );
    REGIST_FUNC_NAME( ScriptSystem, SetBgm, "bgm" );
    REGIST_FUNC_NAME( ScriptSystem, SetSe, "se" );
    REGIST_FUNC_NAME( ScriptSystem, SetStopallse, "stopallse" );
    REGIST_FUNC_NAME( ScriptSystem, SetName, "name" );
    REGIST_FUNC_NAME( ScriptSystem, SetHuman, "human" );
    REGIST_FUNC_NAME( ScriptSystem, SetBackground, "background" );
    REGIST_FUNC_NAME( ScriptSystem, SetStill, "still" );
    REGIST_FUNC_NAME( ScriptSystem, SetLive2d, "live2d" );
    REGIST_FUNC_NAME( ScriptSystem, SetVoice, "voice" );

    // 新しいインスタンス命令
    REGIST_FUNC( ScriptSystem, SetHeart );
    REGIST_FUNC( ScriptSystem, SetBgm );
    REGIST_FUNC( ScriptSystem, SetSe );
    REGIST_FUNC( ScriptSystem, SetStopallse );
    REGIST_FUNC( ScriptSystem, SetName );
    REGIST_FUNC( ScriptSystem, SetHuman );
    REGIST_FUNC( ScriptSystem, SetBackground );
    REGIST_FUNC( ScriptSystem, SetStill );
    REGIST_FUNC( ScriptSystem, SetLive2d );
    REGIST_FUNC( ScriptSystem, SetVoice );
...
SCRIPT( ScriptSystem::SetBackground )
{
    switch ( args.size( ) )
    {
    case 1:
...
SCRIPT( ScriptSystem::SetStopallse )
{
    auto audio = AudioManager::getInstance( );
    audio->stopAllSe( );
}
SCRIPT( ScriptSystem::SetHuman )
{
    switch ( args.size( ) )
    {
    case 1:
