...
namespace User
{
	...
	void UIManager::createMenuWindow()
	{
		...
		//メニューの背景
		auto menuImage = ui::Scale9Sprite::create("Image/WindowBase/WinBase_88.png",
		...
		//メニューウィンドウの開閉用ボタン
		swicthWindow = ui::Button::create("Image/WindowBase/WinBase_1.png");
		...
		{
			menuButtons.push_back(ui::Button::create("Image/WindowBase/WinBase_24.png"));
	...
	void UIManager::setOptionWindow()
	{
		...
		auto menuImage = ui::Scale9Sprite::create("Image/WindowBase/WinBase_59.png",
			Rect(0 / CC_CONTENT_SCALE_FACTOR(), 0 / CC_CONTENT_SCALE_FACTOR(),
				120 / CC_CONTENT_SCALE_FACTOR(), 120 / CC_CONTENT_SCALE_FACTOR()),
			Rect(32 / CC_CONTENT_SCALE_FACTOR(), 32 / CC_CONTENT_SCALE_FACTOR(),
				64 / CC_CONTENT_SCALE_FACTOR(), 64 / CC_CONTENT_SCALE_FACTOR()));
		...
		//CloseButton（仮置き）
		auto closeButton = ui::Button::create("Image/WindowBase/WinBase_18.png");
	...
	void UIManager::createOptionIcon()
	{
		...
		auto optionButton = ui::Button::create("option_icon.png");
