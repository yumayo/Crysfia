/****************************************************************************
 ...
 - MIT license
****************************************************************************/
#ifndef __UserAudioManager__
#define __UserAudioManager__
...
namespace gameHelper2dx
{
    ...
    private:
        ...
        UserAudioManager( );
        static UserAudioManager* _instance;
    ...
    public:
        ...
        ~UserAudioManager( );
        static UserAudioManager* getInstance( );
...
#endif /* defined(__UserAudioManager__) */
